function met = met_importfile(filename,filenum, met, startRow, endRow)
%MET_IMPORTFILE Import numeric data from a text file as column vectors.
%   MET = MET_IMPORTFILE(FILENAME) Reads data
%   from text file FILENAME for the default selection.
%
%   [MET] = IMPORTFILE(FILENAME, STARTROW,
%   ENDROW) Reads data from rows STARTROW through ENDROW of text file
%   FILENAME.
%
% Example:
%   [met] = met_importfile('met_mlo_insitu_1_obop_hour_1977.txt',1, 8760);
%
%    See also TEXTSCAN.
